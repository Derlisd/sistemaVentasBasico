...
public function anular($idingreso){
	$sql1="UPDATE ingreso SET estado='Anulado' WHERE idingreso='$idingreso'";
	ejecutarConsulta1($sql1);
	 $sql="select a.idingreso, b.idarticulo,b.cantidad from ingreso a inner join detalle_ingreso b on a.idingreso = b.idingreso where a.idingreso = '$idingreso'";
	 //return ejecutarConsulta($sql);
	 return ejecutarUpdateCompra($sql);
